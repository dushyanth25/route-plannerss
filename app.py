...
# Constants
MAP_CACHE_FILE = "coimbatore_small_map_cache.pkl"
TRAFFIC_CACHE_FILE = "traffic_data_cache.pkl"
TRAFFIC_UPDATE_INTERVAL = 3600  # 1 hour

# 🔥 Smaller boundary to prevent memory crash
BOUNDARY = {
    "north": 11.05,  # around Coimbatore city center
    "south": 10.95,
    "east": 76.99,
    "west": 76.91
}
...
def get_route():
    ...
    try:
        ...
        distance = sum(
            geodesic((route_coords[i][0], route_coords[i+1][0]), (route_coords[i][1], route_coords[i+1][1])).km
